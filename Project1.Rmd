---
title: Analysis of the Adverse Health and Economic Impacts of United States Storms
  Data
...
download.file(fileUrl,"storm.csv")
stormDF <- read.csv("storm.csv")
...
healthChart = healthChart + theme(axis.text.x = element_text(angle=30, hjust=1))
healthChart = healthChart + ggtitle("Top 10 US Killer Events") + theme(plot.title = element_text(hjust = 0.5))
healthChart
```
...
econChart = econChart + theme(axis.text.x = element_text(angle=30, hjust=1))
